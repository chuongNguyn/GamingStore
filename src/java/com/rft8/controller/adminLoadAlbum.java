 ...
 */
@WebServlet(name = "adminLoadAlbum", urlPatterns = {"/adminLoadAlbum"})
public class adminLoadAlbum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("albumPic", albumPic);
        if (action.equals("edit")) {
            session.setAttribute("editAlbumId", id);
