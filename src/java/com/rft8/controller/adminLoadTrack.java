 ...
 */
@WebServlet(name = "adminLoadTrack", urlPatterns = {"/adminLoadTrack"})
public class adminLoadTrack extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("trackFile", trackFile);
        int id = Integer.parseInt(request.getParameter("trackId"));
        String action = request.getParameter("action");
        if (action.equals("edit")) {
            session.setAttribute("editTrackId", id);
