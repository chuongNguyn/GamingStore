        ...
        <jsp:include page='header.jsp'></jsp:include>
            ...
            <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/core-img/bg-1.jpg);">
                <div class="bradcumbContent" >              
                    <h2>${dao.getArtistNameById(artistId)}</h2>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="weeks-top-area mb-100" style="margin-top:50px">
                        ...
                        <c:forEach items="${dao.getAllAlbumIdByArtistId(artistId)}" var="a">                   
                            <div
                ...
                <div class="col-12 col-lg-4">
                    <div class="card" style="width: 20rem;   margin-top: 50px;">
                        <img class="card-img-top" src="img/artist-img/${dao.getArtistPicById(artistId)}" alt="${dao.getArtistPicById(artistId)}">
                        <div class="card-body">
                            <h5 class="card-text" style="text-align: center;margin-bottom: 20px;">${dao.getArtistDesById(artistId)}</h5>
                             <p class="card-text" style="text-align: center;margin-bottom: 20px;">Active Year: ${dao.getArtistYearById(artistId)}</p>
