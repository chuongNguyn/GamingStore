                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${dao.getAllAlbums()}" var="a">
                                                <c:url var="Edit" value="../adminLoadAlbum">
                                                    <c:param name="action" value="edit" ></c:param>
                                                    <c:param name="albumId" value="${a.getId()}" ></c:param>
                                                   <c:param name="albumPic" value="${a.getPic()}" ></c:param>
                                                </c:url>
                                                <c:url var="Delete" value="../adminLoadAlbum">
