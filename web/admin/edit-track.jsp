                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${dao.getAllTracks()}" var="a">
                                                <c:url var="Edit" value="../adminLoadTrack">
                                                    <c:param name="action" value="edit" ></c:param>
                                                    <c:param name="trackId" value="${a.getId()}" ></c:param>
                                                   <c:param name="trackFile" value="${a.getNameFile()}" ></c:param>
                                                </c:url>
                                                <c:url var="Delete" value="../adminLoadTrack">
