                        ...
                        <div class="card-body">
                            <div>
                                <form action="../adminEditAlbum" method="post" enctype= multipart/form-data>
                                    <input type="hidden" name="albumPic" class="form-control" value="${sessionScope.albumPic}"/>
                                    <div class="form-group">

                                        <label>Id:</label>
                                        <input readonly  type="text" name="id" class="form-control" value="${sessionScope.editAlbumId}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Artist:</label>
                                    ...
                                    <div class="form-group">
                                        <label>Name:</label>
                                        <input type="text" name="name" class="form-control" value="${dao.getAlbumNameById(sessionScope.editAlbumId)}"/>
                                    </div>
                          
                                    <div class="form-group">
                                        <label>Year</label>
                                        <input type="text" name="year" class="form-control" value="${dao.getAlbumReleaseById(sessionScope.editAlbumId)}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Genre:</label>
                                        <select name="genre" class="form-select">
                                            <c:forEach items="${sessionScope.allGenres}" var="g">
